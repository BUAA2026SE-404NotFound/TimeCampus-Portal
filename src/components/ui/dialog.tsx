...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={mergeClassName("flex flex-col gap-2 text-center sm:text-left", className)}
      {...props}
    />
  )
}
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={mergeClassName("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className)}
      {...props}
    />
  )
}
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={mergeClassName("text-lg leading-none font-semibold", className)}
      {...props}
    />
  )
}
